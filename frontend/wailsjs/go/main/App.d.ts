...
import {alldebrid} from '../models';
import {main} from '../models';
import {elysium} from '../models';
...
export function AllDebridUnlock(arg1:string):Promise<alldebrid.UnlockedLink>;
...
export function DeleteMyElyDdl(arg1:number):Promise<void>;

export function DeleteMyElyNzb(arg1:number):Promise<void>;
...
export function ElysiumSearchTitles(arg1:string,arg2:string):Promise<Array<elysium.Title>>;
...
export function GetElysiumMeta():Promise<elysium.Meta>;
...
export function HydrackerGetByIgdbID(arg1:number):Promise<api.PartialTitle>;
...
export function IgdbGetByID(arg1:number):Promise<igdb.Game>;

export function IgdbSearch(arg1:string):Promise<Array<igdb.Game>>;
...
export function ListMyElyDdls(arg1:number):Promise<elysium.Paginated_go_post_tools_internal_elysium_UploadRef_>;

export function ListMyElyNzbs(arg1:number):Promise<elysium.Paginated_go_post_tools_internal_elysium_UploadRef_>;
...
export function PostDDLWorkflow(arg1:number,arg2:string,arg3:string,arg4:Array<string>,arg5:Array<string>,arg6:string,arg7:string,arg8:number,arg9:number):Promise<main.DDLWorkflowResult>;
...
export function PostNzbWorkflow(arg1:number,arg2:string,arg3:string,arg4:Array<string>,arg5:Array<string>,arg6:string,arg7:string,arg8:number,arg9:number):Promise<main.NzbWorkflowResult>;
...
export function TestIgdb(arg1:string,arg2:string):Promise<string>;
